...
$(document).ready(function() {
  ...
  $("#consent-decline").click(function() {
    ...
    $("body").text("Thank you for your interest in completing this HIT. Unfortunately, you mus agree to the consent form to continue. Please click \"Return HIT\" to allow someone else to work on this task.");
  });
});
